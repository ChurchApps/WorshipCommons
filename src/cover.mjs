...
const ICONS = {
  ...
  anchor: {
    ...
    segs: [
      ...
      [[0.26, 0.58], [0.30, 0.68], [0.38, 0.75], [0.5, 0.78]],
      [[0.74, 0.58], [0.70, 0.68], [0.62, 0.75], [0.5, 0.78]],
      [[0.26, 0.58], [0.22, 0.66]],
      [[0.74, 0.58], [0.78, 0.66]]
    ]
  },
  ...
  book: {
    halo: [0.5, 0.20],
    segs: [
      [[0.22, 0.40], [0.34, 0.36], [0.48, 0.40]],
      [[0.48, 0.40], [0.62, 0.36], [0.78, 0.40]],
      [[0.22, 0.62], [0.34, 0.58], [0.48, 0.62]],
      [[0.48, 0.62], [0.62, 0.58], [0.78, 0.62]],
      [[0.22, 0.40], [0.22, 0.62]],
      [[0.78, 0.40], [0.78, 0.62]],
      [[0.48, 0.40], [0.48, 0.62]]
    ]
...
const POOL = [
  "waves", "arcs", "peaks", "rays", "star", "lattice", "crown", "dove", "anchor", "harp", "candle", "wheat", "mountains", "fish", "book", "staff"
];
