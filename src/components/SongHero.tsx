...
export default function SongHero({ song, keyLabel, writerHref, leadHref, inLibrary, onToggleLibrary, supportLinks = [] }: Props) {
  const { t } = useI18n();
  ...
  return (
    <section className="song-hero" data-testid="song-hero">
      ...
      <div className="hero-actions">
        ...
        {supportLinks.length > 0 && <SupportWriter links={supportLinks} writer={song.writer} />}
      </div>
    </section>
  );
}
